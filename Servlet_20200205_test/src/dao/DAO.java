...
public class DAO {
	...
	public int inserts(memberDTO va) {
		...
		try {
			...
			pstmt.setString(2, va.getPassword());
			pstmt.setString(3, va.getName());
			pstmt.setString(4, va.getBirth());
			pstmt.setString(5, va.getGender());
			pstmt.setString(6, va.getEmail());
			ss = pstmt.executeUpdate();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
