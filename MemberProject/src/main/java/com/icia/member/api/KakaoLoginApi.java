...
private final static String K_CLIENT_ID = "cfa2e44c4e7e2ef16cf082aec78495d5";
// 카카오 개발자 페이지에서 로그인 Redirect URI 에 설정한 값
private final static String K_REDIRECT_URI = "http://localhost:8090/member/hnkakaoLoginOK";
