...
public class NaverLoginApi {
	...
	private final static String CLIENT_ID = "6zS2EstM0t1078EVrrbJ";
	private final static String CLIENT_SECRET = "dICyHQ1Erk";

	private final static String REDIRECT_URI = "http://localhost:8090/member/hnnaverLoginOK";
